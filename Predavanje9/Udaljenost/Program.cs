/* 5. Napiši program koji računa udaljenost između dvije točke P(x, y) i R(z, k).
d=√(x−z)2+/(y−k)2
Napomena: Napraviti posebnu metodu za unos koordinate točke i pozvati ju dva puta unutar
