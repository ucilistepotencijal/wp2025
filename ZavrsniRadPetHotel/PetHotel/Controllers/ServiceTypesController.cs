...
namespace PetHotel.Controllers
{
    public class ServiceTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,IsActive")] ServiceType serviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,IsActive")] ServiceType serviceType)
        {
