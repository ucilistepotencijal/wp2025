...
Console.WriteLine("Zaposlenik 2 - Ime: {0}, Prezime: {1}, OIB: {2}, Broj bodova: {3}, Vrijednost boda: {4}",
    z2.Ime, z2.Prezime, z2.OIB, z2.BrojBodova, z2.VrijednostBoda);

Zaposlenik z3 = new Zaposlenik("Ivo", "Ivić", "09876543210");
z3.BrojBodova = 4;
z3.VrijednostBoda = 1000;
Console.WriteLine("Zaposlenik 3 - Ime: {0}, Prezime: {1}, OIB: {2}, Broj bodova: {3}, Vrijednost boda: {4}",
